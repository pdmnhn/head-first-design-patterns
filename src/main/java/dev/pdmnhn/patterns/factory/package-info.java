 ...
 * <p>
 * Pattern used in this chapter: <b>Factory Method Pattern</b> and it's different variants are 1. Simple factory which
 * encapsulates object creation while not a bona fide design pattern, is a simple way to decouple your clients from
 * concrete classes.
 * <p>

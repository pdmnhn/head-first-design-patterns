 ...
 * Design Principles,
 * <p>
 * 1. The Principle of Least Knowledge: talk only to your immediate friends.
 * The Principle of Least knowledge guides us to reduce the interactions between objects to just a few close "friends".
 * <p>
 * First pattern used in this chapter: <b> Adapter Pattern</b>,
 ...
 * <p>
 * Second pattern used in this chapter: <b> Facade Pattern </b>,
 ...
 */
package dev.pdmnhn.patterns.adapterandfacade;
